...
const intereses = ref([
    'Desarrollo de Software de Código Abierto: Nos encanta contribuir en proyectos de GitHub, colaborando para fortalecer herramientas y librerías populares.',
    'Deportes al Aire Libre: Disfrutamos del senderismo y el ciclismo de montaña, actividades que practicamos regularmente para mantener un equilibrio entre el trabajo y la vida personal.',
    'Tecnología de Innovación: Nos apasiona explorar nuevas tendencias tecnológicas como la inteligencia artificial y el desarrollo de aplicaciones móviles.',
